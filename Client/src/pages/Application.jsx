        ...
        <table className='min-w-full bg-white border border-gray-200 rounded-lg'>
          ...
          <tbody>
            {userApplications.map((job, index) => true ? (
              <tr key={index}>
                <td className='py-4 px-4 flex items-center gap-2 border-b border-gray-200'>
                ...
                <td className='py-2 px-4 border-b border-gray-200 max-sm:hidden'>{moment(job.jobId.date).format('ll')}</td>
                <td className='py-2 px-4 border-b border-gray-200'>
